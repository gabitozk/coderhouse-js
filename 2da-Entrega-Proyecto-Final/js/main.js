...
const dropdownFavoritos = document.querySelector("#dropdown-favoritos");
...
dropdownFavoritos.addEventListener("mouseover", () => {
  favHeader.style.display = "block";
});

dropdownFavoritos.addEventListener("mouseleave", () => {
